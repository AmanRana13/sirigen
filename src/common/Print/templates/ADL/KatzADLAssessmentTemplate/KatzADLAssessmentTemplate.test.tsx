...
import KatzADLAssessmentTemplate from './KatzADLAssessmentTemplate.component';
import { IKatzADLSectionData } from './KatzADLAssessmentTemplate.types';

const dummyData: IKatzADLSectionData[] = [
    {
        "surveyName": "0",
        "surveyData": {
            "title": "BATHING",
...
describe('Print: KatzADLAssessmentTemplate', () => {
  test('renders KatzADLAssessmentTemplate component', () => {
    const {queryByTestId} = render(
      <KatzADLAssessmentTemplate data={dummyData} />,
    );
    const element = queryByTestId('katz-template');
